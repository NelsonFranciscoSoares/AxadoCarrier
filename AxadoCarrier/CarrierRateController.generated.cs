...
namespace AxadoCarrier.Controllers
{
    public partial class CarrierRateController
    {
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "CarrierRate";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "CarrierRate";
        [GeneratedCode("T4MVC", "2.0")]
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CarrierRateController : AxadoCarrier.Controllers.CarrierRateController
    {
        public T4MVC_CarrierRateController() : base(Dummy.Instance) { }
